...
residues_file = f'{cwd}/input/residues_C2DNA.csv'
...
components.add(name='actg_bp280',molecule_type='rna', nmol=1, restraint=True,
               restraint_type='harmonic', k_harmonic=30, cutoff_restr=1.5,
               use_com = False)
