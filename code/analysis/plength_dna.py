...
def main(stack_n,krstr,path='../md/single_dsACUG_stiff_grid_l014/',seqname='dsACUG',l_key=""):  #def main(krstr,key=''):
    name = 'md' #'acug'
    dir_= path + f'single_{seqname}_n{stack_n}_k{krstr}{l_key}/{name}/'
    b = 100 # 100 ns
    ...
    # per turn
    index_per_turn = np.arange(0, 150, 21)
...
stack_n = 136
#for krstr in [8,15,20,25,28,30]:
#    main(stack_n,krstr,path='../dna_md/', seqname='dsACTG')


l_key = '_l065'
for krstr in [15,20,25,30]:
    main(stack_n,krstr,path='../dna_md/', seqname='dsACTG')
