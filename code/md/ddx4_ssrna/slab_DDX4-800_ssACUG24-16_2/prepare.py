...
components.add(name='DDX4',molecule_type='protein', nmol=800,restraint=False,ext_restraint=True)
components.add(name='ss_acug24',molecule_type='rna', nmol=16, restraint=False,ext_restraint=True) 
