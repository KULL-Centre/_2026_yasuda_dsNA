...
components.add(name='CAPRIN1_N623TN630T_RK',molecule_type='protein', nmol=500,restraint=False,ext_restraint=True)

components.add(name='sspolyR12', molecule_type='rna', nmol=500,
               rna_kb1 = 1400.0,
               rna_kb2 = 2200.0,
               rna_ka = 4.20,
               rna_pa = 3.14,
...
components.add(name='label_sspolyR12', molecule_type='rna', nmol=30,
               rna_kb1 = 1400.0,
               rna_kb2 = 2200.0,
               rna_ka = 4.20,
               rna_pa = 3.14,
